...
public class AutonRightStackDownness extends AutonDriving{
    ...
    public void squarePathSignalSketch(AprilTagDetection tagOfInterest){
        if(tagOfInterest.id == 1){
            encoderDriveSketch(0.5, 90, 50,2, 0.1);
            encoderDriveSketch(0.5, 270, 4, 2,0.1);
            encoderDriveSketch(0.5, 0,32,3,0.08);
        }
        else if(tagOfInterest.id == 2){
            encoderDriveSketch(0.5, 90, 46,2,0.1);
        }
        else if(tagOfInterest.id == 3){
            encoderDriveSketch(0.5, 90, 50,2,0.1);
            encoderDriveSketch(0.5, 270, 4, 2,0.1);
            encoderDriveSketch(0.5, 180,34,3,0.08);
        }
    }
